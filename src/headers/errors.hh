...
#define BM_ERR_SHADER_COMPILE_PANIC (__BM_ERRBASE + 5)
#define BM_ERR_SHADER_COMPILE_PANIC_MESSAGE "Compile shader fails without logs"

#define BM_ERR_SHADER_COMPILE (__BM_ERRBASE + 6)
#define BM_ERR_SHADER_COMPILE_MESSAGE "Shader failed"

#define BM_ERR_VERT_SHADER_COMPILE (__BM_ERRBASE + 7)
#define BM_ERR_VERT_SHADER_COMPILE_MESSAGE "Vertex shader failed"

#define BM_ERR_FRAG_SHADER_COMPILE (__BM_ERRBASE + 8)
...
#define BM_ERR_LINK_PROGRAM (__BM_ERRBASE + 10)
#define BM_ERR_LINK_PROGRAM_MESSAGE "Error linking program"

#define BM_ERR_LOAD_SHADERS (__BM_ERRBASE + 11)
